...
const Employeeexam = () => {
  ...
  const sendData = () => {
    if (classId === "") {
      ...
      axios
        .post("http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/exam/add-exam", data)
        .then((response) => {
          handleClose();
          reload();
        })
  ...
  const sendResult = () => {
    ...
    console.log("data1",data1)
      axios
        .post("http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/result/add-result", data1)
        .then((response) => {
          handleClose4();
          reload();
        })
  ...
  useEffect(() => {
    axios
      .get(`http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/exam?page=0&size=25`)
      .then((response) => {
    ...
    axios
      .get(
        `http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/subject/linked-subject/12/Section_D`
      )
      .then((response) => {
  ...
  const deleteData = () => {
    ...
    axios
      .delete(
        `http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/exam/` + localStorage.getItem("exam_id")
      )
      .then((response) => {
        // console.log(response);
        remove();
  ...
  const sendUpdated = () => {
    {
      axios
        .patch(`http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/exam/edit-exam`, {
  ...
  const active = (id) => {
    console.log(id);
    axios
      .patch(`http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/exam/disable-exam/` + id)
      .then((response) => {
