...
import Request from "./Request/requestTeacher"
const Finance = () => {
    ...
    useEffect(() => {
        axios.get(Request.GetAllTeacher,{
          headers: {
...
>>>>>>> Stashed changes
    ...
    const deleteData = () => {
        ...
        axios.delete(Request.deleteTeacher+localStorage.getItem("user_id"),{
          headers: {
            'Authorization': `Bearer ${localStorage.getItem("access")}` 
          }
        })
    ...
    const sendData = () => {
        if (password != confirmpassword) {
            ...
            if (/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test(email)) {
                axios.post(Request.signUp, data)
                    .then(response => {
                        console.log(response);
                                ...
                                <table class="table no-wrap">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">&ensp; Delete</th>
