...
setClassdata(sorted)
  ...
  const sendData = (e) => {
    if (schoolClass === "") {
      ...
      console.log("ss",localStorage.getItem("access"))
      axios
<<<<<<< Updated upstream
<<<<<<< Updated upstream
        .post("https://65.2.31.39/erpdev/api/class/create-new", data)
=======
=======
...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
    .delete("https://65.2.31.39/erpdev/api/class/"+localStorage.getItem("user_id")+"?eventType=Delete%20Class")
=======
=======
...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
      .get("https://65.2.31.39/erpdev/api/class/"+id+"?eventType=Get%20Class%20%20By%20Id")
=======
=======
...
>>>>>>> Stashed changes
  ...
  const sendUpdated = () => {
    if (schoolClass === "") {
      ...
      axios
        .patch(
          `https://65.2.31.39/erpdev/api/class/update`,
          { 
            classId: class_id, 
            classNumber:schoolClass, 
