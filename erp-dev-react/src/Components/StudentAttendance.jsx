...
const sendData1 = (id,id1,id2) => {
  ...
  console.log(data);
  axios
    .post("http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/attend/mark-attendance",data)
    .then((response) => {
...
const sendData = (e) => {
  ...
  axios
    .get("http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/api/class/get-students?classNumber="+classid+"&page=0&sectionName="+sectionid+"&size=25")
    .then((response) => {
      console.log(sectiondata);
        console.log(response.data.responseBody.content);
