...
export default function Analytics() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/api/class/Get%20All%20Class`
      )
      .then((response) => {
    ...
    axios
      .get(
        `http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/exam?page=0&size=25`
      )
      .then((response) => {
      ...
      axios
      .get(
        `http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/user?eventType=Get_ALL_Users&page=0&roles=Student&size=25&sortBy=userId`
      )
      .then((response) => {
    ...
    axios
      .get(
        `http://erpcd-erpde-13vw78n5lwhpz-1518206987.ap-south-1.elb.amazonaws.com/erpdev/user?eventType=Get_ALL_Users&page=0&roles=Teacher&size=25&sortBy=userId`
      )
      .then((response) => {
        // console.log(response.data)
